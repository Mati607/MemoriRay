...
class BamlAsyncClient:
    ...
    async def ImageDescription(self, image_b64: baml_py.Image,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = await self.__options.merge_options(baml_options).call_function_async(function_name="ImageDescription", args={
                "image_b64": image_b64,
            })
            return typing.cast(str, result.cast_to(types, types, stream_types, False, __runtime__))
...
class BamlStreamClient:
    ...
    def ImageDescription(self, image_b64: baml_py.Image,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_async_stream(function_name="ImageDescription", args={
            "image_b64": image_b64,
        })
        return baml_py.BamlStream[str, str](
          result,
